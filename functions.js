...
function timeElapse(c){
  ...
  var a = '记录我们相识相知 <span class="digit">' + g + '</span> 天的点点滴滴...'
    $("#elapseClock").html(a)
}
...
function adjustWordsPosition(){
	...
	$("#image_xm").css("position", "absolute");
    $("#image_xm").css("top", $("#garden").position().top + 167);
    $("#image_xm").css("left", $("#garden").position().left + 285);
}
